...
import Bag from "/img/14.svg";
import HeartIcon from "/img/heart.png";
import SearchIcon from "/img/searchwhiteicon.png";
import BagIcon from "/img/iconbag.png";
        ...
        <div className="duration-400 hidden duration-100 transition-all group-hover:flex absolute bottom-0 w-full bg-grayUi text-white justify-between items-center p-2">
          ...
          {type == "2" && (
            <>
              ...
              <p className="capitalize">{product.quantity} product</p>
            </>
          )}
        </div>
      </div>
